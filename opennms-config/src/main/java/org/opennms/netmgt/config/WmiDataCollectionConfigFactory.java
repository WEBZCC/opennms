 ...
 */
public class WmiDataCollectionConfigFactory extends AbstractCmJaxbConfigDao<WmiDatacollectionConfig> {
    ...
    public WmiDataCollectionConfigFactory() throws IOException {
        super(WmiDatacollectionConfig.class, "Wmi Configuration");
    }

    public WmiDataCollectionConfigFactory (WmiDatacollectionConfig config) {
        super(WmiDatacollectionConfig.class, "Wmi Configuration");
        m_config = config;
    }
